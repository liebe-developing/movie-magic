...
const MoviePage = () => {
  ...
  return (
    <section
      className={`h-auto w-full  dark:bg-hero bg-bottom bg-cover bg-no-repeat shadow-black`}
    >
      <div className="flex sm:max-w-7xl mx-auto pt-[100px] pb-4 items-center text-sm relative font-iransans dark:text-white max-sm:pr-4">
        ...
        <div className="flex flex-col md:flex-row px-5 sm:px-[119px] h-auto pt-8 sm:h-[800px] backdrop-brightness-[0.3] gap-7">
          <div>
            <img
              ...
              alt="movie poster"
              width={345}
              className="max-sm:h-[394px] rounded-lg border-t-[3px] border-x-[1.5px] border-x-orange-500 border-t-orange-500 shadow-lg shadow-orange-500/40"
            />
          </div>
      ...
      <div className="py-8">
        <h2 className="font-vazir font-semibold sm:px-[119px] px-4 text-2xl">
          بازیگران
        </h2>
        <Swiper
          navigation={true}
